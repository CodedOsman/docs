...
**Step 3:** Connect the negative leg of the first LED to GND on the Arduino Uno. Connect the positive leg of the second LED to pin 9 on the Arduino through a 220Ω resistor.

![Push Button 2.3](../../../assets/1.0/Push_Button/Push_Button_Two_LED/circuit_3.png)

**Step 4:** Connect the negative leg of the second LED to GND on the Arduino Uno. Connect the positive leg of the second LED to pin 7 on the Arduino through a 220Ω resistor.

![Push Button 2.4](../../../assets/1.0/Push_Button/Push_Button_Two_LED/circuit_4.png)

**Step 5:** Place the push button on the breadboard.

![Push Button 2.6](../../../assets/1.0/Push_Button/Push_Button_Two_LED/circuit_6.png)

**Step 6:** Connect one side of the push button to GND on the Arduino Uno.
