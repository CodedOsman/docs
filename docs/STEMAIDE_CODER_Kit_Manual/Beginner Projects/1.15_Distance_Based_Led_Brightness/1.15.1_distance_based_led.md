...
**Step:** Place the HC-SR04 ultrasonic sensor on the breadboard. Connect the VCC pin to 5V, the GND pin to GND, the TRIG pin to Digital Pin 9, and the ECHO pin to Digital Pin 10 on the Arduino.

![inseting push button](../../../assets/1.0/Distance_Based_Led_Brightness/circuit_1.png).

**Step 2:** Place the LED on the breadboard. Connect the longer leg (anode) to one leg of a resistor. Then, connect the other leg of the resistor to Digital Pin 3 and the shorter leg (cathode) to GND on the Arduino. 
