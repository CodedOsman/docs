# Project 1.1.9: Turn ON Five LEDs
...
`pinMode(6, OUTPUT);` `pinMode(5, OUTPUT);`  `pinMode(4, OUTPUT);` `pinMode(3, OUTPUT);` `pinMode(2, OUTPUT);`
...
`digitalWrite(6, HIGH);` `digitalWrite(5, HIGH);` `digitalWrite(4, HIGH);` `digitalWrite(3, HIGH);` `digitalWrite(2, HIGH);`
