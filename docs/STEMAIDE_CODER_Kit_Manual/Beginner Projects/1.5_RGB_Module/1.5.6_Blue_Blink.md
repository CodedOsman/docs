...
| **Description** | A blinking blue LED means the system is working normally and everything is okay. |
|------------------|----------------------------------------------------------------|
...
| ![Arduino Uno](../../../assets/components/arduino.webp) | ![Arduino USB Cable](../../../assets/components/usbcable.webp) | ![Breadboard](../../../assets/components/breadboard.webp) |![Jumper Wires](../../../assets/components/jumperwires.webp)|![Breadboard](../../../assets/components/RGB.webp)
|-------------------------|-------------------------|-------------------------|-------------------------|-------------------------|
...
**Step 2:** Connect the blue jumper wire from the B pin of the RGB module to pin 7 on the Arduino UNO.
Then connect the brown jumper wire from the – (GND) pin of the RGB module to the GND pin on the Arduino UNO.
