...
**Step 1:** Place the sound sensor module on the breadboard. Connect the VCC pin to 5V, the GND pin to GND, and the AO (Analog Output) pin to A0 on the Arduino using jumper wires.

![inseting push button](../../../assets/1.0/Noise_level_alarm/circuit_1.png).

**Step 2:** Place the buzzer on the breadboard. Connect the positive (+) terminal to Digital Pin 3 and the negative (−) terminal to GND on the Arduino using jumper wires.
