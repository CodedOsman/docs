...
| ![LED](../../../assets/components/trafficmodule.webp) | ![Arduino Uno](../../../assets/components/arduino.webp) | ![Arduino USB Cable](../../../assets/components/usbcable.webp) | ![Breadboard](../../../assets/components/breadboard.webp) |![Jumper Wires](../../../assets/components/jumperwires.webp)| ![Ultrasonic Sensor](../../../assets/components/ultrasonic.webp)|
|-------------------------|-------------------------|-------------------------|-------------------------|-------------------------|-------------------------|
...
const int redLed = 3;     // Red Light
const int yellowLed = 4;  // Yellow Light
const int greenLed = 5;   // Green Light
...
```
![code 1](../../../assets/3.0/Smart_Traffic_Light_System/code_1.png).

![code 2](../../../assets/3.0/Smart_Traffic_Light_System/code_2.png).

![code 3](../../../assets/3.0/Smart_Traffic_Light_System/code_3.png).

![code 4](../../../assets/3.0/Smart_Traffic_Light_System/code_4.png).

**Step 19:** Save your code. _See the [Getting Started](../../Getting Started/Arduino_IDE_Setup.md) section_

**Step 20:** Select the arduino board and port _See the [Getting Started](../../Getting Started/Arduino_IDE_Setup.md)_.

**Step 21:** Upload your code.
