...
| ![Arduino Uno](../../../../assets/components/arduino.webp) | ![Arduino USB Cable](../../../../assets/components/usbcable.webp) | ![Breadboard](../../../../assets/components/breadboard.webp) |![Jump wire](../../../../assets/components/jumperwires.webp)|![LED](../../../../assets/components/leds.webp)|![Sound Sensor](../../../../assets/2.0/7.3.SoundSensor + Traffic/SoundSensor.webp)|
|-------------------------|-------------------------|-------------------------|-------------------------|------------------------|--------------------------|
...
**Step 3:** Connect the green male-to-male jumper wire to (D0) on the sound sensor and the other end of the wire to digital pin 6 on the Arduino board as shown below.
