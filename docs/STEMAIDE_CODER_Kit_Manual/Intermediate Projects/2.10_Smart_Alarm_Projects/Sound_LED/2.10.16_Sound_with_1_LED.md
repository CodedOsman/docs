...
![LED fixed on breadboard](../../../../assets/2.0/7.1SoundSensor+LED1/circuit_1.png).
...
![LED fixed on breadboard](../../../../assets/2.0/7.1SoundSensor+LED1/circuit_2.png).
...
![LED fixed on breadboard](../../../../assets/2.0/7.1SoundSensor+LED1/circuit_3.png)
...
![Pinmode decalration](../../../../assets/2.0/7.1SoundSensor+LED1/code1.webp).
...
![LED fixed on breadboard](../../../../assets/2.0/7.1SoundSensor+LED1/code2.webp).
...
![LED fixed on breadboard](../../../../assets/2.0/7.1SoundSensor+LED1/code3.webp).
-	The above code reads data from the soundSensorPin.

**Step 3:** Type ```if (soundValue > 100 ) {  }``` as shown below; 

![LED fixed on breadboard](../../../../assets/2.0/7.1SoundSensor+LED1/code4.webp).

**Step 3:** Type ```else { } ; ``` as shown in the image below; 

![LED fixed on breadboard](../../../../assets/2.0/7.1SoundSensor+LED1/code5.webp).
...
![Pinmode decalration](../../../../assets/2.0/7.1SoundSensor+LED1/code6.webp).

**Step 3:** Type ``` digitalWrite (LED, LOW); ``` as shown in the image below; 

![LED fixed on breadboard](../../../../assets/2.0/7.1SoundSensor+LED1/code7.webp).
