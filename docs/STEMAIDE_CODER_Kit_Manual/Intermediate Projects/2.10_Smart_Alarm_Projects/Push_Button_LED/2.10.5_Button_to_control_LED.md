# Project 2.5.1:LED Control with Arduino and Push Button
...
![inseting push button](../../../../assets/2.0/2.1.PushButton+LED/2.LED/2.code_1.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.Push Button + LED/img_3.webp).
