# Project 2.5.3:LED Control with Arduino and Push Button
...
![inseting push button](../../../../assets/2.0/2.1.PushButton+LED/2.LED/image_1.webp).

**step 2:** Inset two (2) LED s on the breadboard as shown in the picture below.

![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/2.LED/image_2.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/2.LED/wire_1.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/2.LED/wire_2.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/2.LED/wire_3.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/2.LED/wire_4.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/2.LED/wire_5.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/2.LED/wire_6.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/2.LED/2.code_1.png).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/2.LED/2.code_2.png).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/2.LED/2.code_3.png).
...
**Step 3:** Upload your code. \_See the [Getting Started](../../../Getting Started/Arduino_IDE_Setup.md) section:Selecting Arduino Board Type and Uploading your code
