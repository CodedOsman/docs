# Project 2.10.10: Four LEDs Control With Push Button

| **Description** | You will learn how to create a simple circuit using a Push button and 4 LEDs.|
| --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Use case** |The use case for using a push butt onto control the blinking of LEDs is to provide customizable visual feedback, signaling/alerting functionality, interactive lighting, educational demonstrations, or prototyping/testing capabilities.|
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.img_1.webp).

**step 2** Inset four (4) LEDs on the breadboard as shown in the picture below.
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.img_2.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.wire_1.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.wire_2.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.wire_3.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.wire_4.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.wire_5.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.wire_6.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.wire_7.webp).

**step 8:** Connect male-to-male jumper wire from the Arduino GND to the one of the negative holes on the breadboard.
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.wire_8.webp).
...
![code 1](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.code_1.webp).
...
![code 2](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.code_2.webp).
...
![code 3](../../../../assets/2.0/2.1.PushButton+LED/4.LED/2.code_3.webp).
