...
![inseting push button](../../../../assets/2.0/2.1.PushButton+LED/img_1.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/img_2.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/img_3.webp).

_**Note:** NB: This completes the circuit for the LED, allowing current to flow from the digital pin, through the LED and back to ground._

## WIRING THE CIRCUIT

**step 1:** Connect red male-to-male jumper wire from the free end of the resistor to digital pin (3) on the Arduino UNO.
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/wire_1.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED//wire_2.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED//wire_3.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/wire_4.webp).
...
![code 1](../../../../assets/2.0/2.1.PushButton+LED/code_1.webp).
...
![code 3](../../../../assets/2.0/2.1.PushButton+LED/code_2.webp).
...
```
![inseting the buzzer](../../../../assets/2.0/2.1.PushButton+LED/code_3.webp).
...
## CONCLUSION
In conclusion, this project demonstrates how a simple push button can be used to control a red LED using an Arduino Uno. It helps to understand how digital input from a button can trigger a response in an output device such as an LED. This forms the basic foundation of many electronic control systems, including switches, indicators, and automation devices used in real-life applications.