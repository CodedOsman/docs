# Project 2.10.4: SMART ALERT LIGHTINING SYSTEM 
...
![blue LED fixed on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_1.png).
...
![red wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_2.png)
...
![black wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_3.png).
...
![white wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_4.png).
...
![blue wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_5.png).

**Step 5:** Connect one end of the brown male-to-male jumper wire to the negative pin of the Red LED and the other end to digital pin GND on the Arduino Uno board as shown in the picture below.

![brown wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_6.png).

**Step 6:** Connect one end of the green male-to-male jumper wire to the positive pin of the Red LED and the other end to pin 13 on the Arduino Uno board as shown in the picture below.

![green wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_7.png).
...
![green wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_8.png).
...
![violet wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_9.png).
...
![orange wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_10.png).
...
![gray wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_11.png).
...
![yellow wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_12.png).
...
![yellow wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_13.png).
...
![yellow wire on breadboard](../../../../assets/2.0/1.4.Ultrasonic+4LED/circuit_14.png).
...
**Step 23:** Type the conditional statement to turn on the LED at a distance less than the threshold distance.
   ...
   ```
![Code 20](../../../../assets/2.0/1.4.Ultrasonic+4LED/code_17.webp).
...
![Code 21](../../../../assets/2.0/1.4.Ultrasonic+4LED/code_19.webp).


**Step 26:** Save your code. _See the [Getting Started](../../../Getting Started/Arduino_IDE_Setup.md) section_

**Step 27:** Select the arduino board and port _See the [Getting Started](../../../Getting Started/Arduino_IDE_Setup.md) section:Selecting Arduino Board Type and Uploading your code_.

**Step 28:** Upload your code. _See the [Getting Started](../../../Getting Started/Arduino_IDE_Setup.md) section:Selecting Arduino Board Type and Uploading your code_
