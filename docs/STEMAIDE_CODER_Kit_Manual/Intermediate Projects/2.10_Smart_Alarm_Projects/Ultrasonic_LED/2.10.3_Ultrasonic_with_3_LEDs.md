# Project 2.10.3: LED and Ultrasonic Sensor Control 
...
![Ultrasonic sensor fixed on breadboard](../../../../assets/2.0/1.1.Ultrasonic+LED/ultrasonic_on_breadboard.png).
...
![red LED fixed on breadboard](../../../../assets/2.0/1.1.Ultrasonic+LED/ultrasonic_led.png).
...
![green LED fixed on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_1.png).
...
![white LED fixed on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_2.png).
...
![red wire on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_3.png)
...
![black wire on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_4.png).
...
![white wire on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_5.png).
...
![blue wire on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_6.png).

**Step 5:** Connect one end of the yellow male-to-male jumper wire to the negative pin of the arduino uno and the other to the negative section on the breadboard.

![yellow wire on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_7.png).

**Step 6:** Connect one end of the brown male-to-male jumper wire to the negative pin of the Red LED and the other end to the negative on the breadboard as shown in the picture below.

![brown wire on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_8.png).

**Step 7:** Connect one end of the green male-to-male jumper wire to the positive pin of the Red LED and the other end to pin 13 on the Arduino Uno board as shown in the picture below.

![green wire on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_9.png).

**Step 8:** Connect one end of the violet male-to-male jumper wire to the positive pin of the Green LED and the other end to pin 10 on the Arduino Uno board as shown in the picture below.

![violet wire on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_10.png).

**Step 8:** Connect one end of the orange male-to-male jumper wire to the negative pin of the green LED and the other end to the negative on the breadboard as shown in the picture below.

![orange wire on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_11.png).
...
![gray wire on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_12.png).

**Step 10:** Connect one end of the yellow male-to-male jumper wire to the negative pin of the white LED and the other end to the negative on the breadboard as shown in the picture below.

![yellow wire on breadboard](../../../../assets/2.0/1.3.Ultrasonic+3LED/circuit_13.png)
...
![Code 6](../../../../assets/2.0/1.3.Ultrasonic+3LED/code_2.webp).
...
![Code 11](../../../../assets/2.0/1.3.Ultrasonic+3LED/code_7.webp).
...
![Code 19](../../../../assets/2.0/1.3.Ultrasonic+3LED/code_15.webp).
...
![Code 20](../../../../assets/2.0/1.3.Ultrasonic+3LED/code_17.webp).
...
**Step 24:** Save your code. _See the [Getting Started](../../../Getting Started/Arduino_IDE_Setup.md) section_

**Step 25:** Select the arduino board and port _See the [Getting Started](../../../Getting Started/Arduino_IDE_Setup.md) section:Selecting Arduino Board Type and Uploading your code_.

**Step 26:** Upload your code. _See the [Getting Started](../../../Getting Started/Arduino_IDE_Setup.md) section:Selecting Arduino Board Type and Uploading your code_
