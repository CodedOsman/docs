...
**Step 1:** Save your code. _See the [Getting Started](../../Getting%20Started/Arduino_IDE_Setup.md) section_.

**Step 2:** Select Arduino Uno from Tools → Board.

**Step 3:** Select the correct COM port from Tools → Port.
