...
| ![Arduino Uno](../../../assets/components/arduino.webp) | ![Arduino USB Cable](../../../assets/components/usbcable.webp) | ![Breadboard](../../../assets/components/breadboard.webp) |![Jump wire](../../../assets/components/jumperwires.webp)|![Traffic Light Module](../../../assets/components/trafficmodule.webp)|![Light Dependable Resistor](../../../assets/components/ldr.webp)|
|-------------------------|-------------------------|-------------------------|-------------------------|-------------------------|--------------------------|
...
**Step 15:** Type  as shown below in the image.
```cpp
...
**Step 17:** Type as shown below in the image.
   ```cpp
else {
        digitalWrite (RED_PIN, LOW);
        digitalWrite (GREEN_PIN, LOW); 
