...
![Components on breadboard](../../../assets/2.0/7.3.SoundSensor%20+%20Traffic/circuit_2.png)
...
![Components on breadboard](../../../assets/2.0/7.3.SoundSensor%20+%20Traffic/circuit_3.png)

**Step 3:** Take the brown male-to-male jumper wire. Connect one end to the “+” port in front of the sound sensor and the other end to the 5V port on the Arduino Uno, as shown in the picture below.

![Components on breadboard](../../../assets/2.0/7.3.SoundSensor%20+%20Traffic/circuit_4.png)
...
![Components on breadboard](../../../assets/2.0/7.3.SoundSensor%20+%20Traffic/circuit_5.png)

**Step 5:**Connect the Green (G) pin of the traffic light module to digital pin 7 on the Arduino Uno using a male-to-male jumper wire.

![Components on breadboard](../../../assets/2.0/7.3.SoundSensor%20+%20Traffic/circuit_6.png)
...
![Components on breadboard](../../../assets/2.0/7.3.SoundSensor%20+%20Traffic/circuit_7.png)
...
![Components on breadboard](../../../assets/2.0/7.3.SoundSensor%20+%20Traffic/circuit_8.png)
