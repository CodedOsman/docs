...
| ![Arduino Uno](../../../docs/manuals/assets/components/arduino.png) | ![RGB Module](../../../docs/manuals/assets/components/RGB_Module.png) | ![Bread Board](../../../docs/manuals/assets/components/breadboard.png) | ![Arduino USB Cable](../../../docs/manuals/assets/components/USB_Cable.png) | ![Ultrasonic Sensor](../../../docs/manuals/assets/components/ultrasonic.png) | ![Jumper wires](../../../docs/manuals/assets/components/jump_wire.png) |
| --------------------------------------------------- | ------------------------------------------------------ | ----------------------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------ |
...
![Mount the RGB Module on the Breadboard](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/RGB.jpg).
...
![connect red jumper wire](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/Rwire.jpg).
...
![connect green jumper wire](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/Gwire.jpg).
...
![connect blue jumper wire](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/Bwire.jpg).
...
![connect white jumper wire](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/Wwire.jpg).
...
![connect red jumper wire to RGB](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/Rred.jpg).
...
![connect green jumper wire to RGB](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/Rgreen.jpg).
...
![connect blue jumper wire to RGB](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/RBlue.jpg).
...
![connect white jumper wire to RGB](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/Rwhite.jpg).
...
![connect USB cable to laptop](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/Rusb.jpg).
...
![create Green Light variable](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/Lgreen.png).

**Step 6:** Type `int Blue = 6; `
as shown below in the picture below: on line one before void Setup() function.

![create Blue Light variable](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/rectify.png).

**Step 7:** Type `long duration; ` and Type ` long duration;`
as shown below in the picture below: on line one before void Setup() function.

![declare duration and distance variable](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/duration.png).
...
![create a threshold](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/thres.png).
...
![create a new function](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/function1.png).
...
![The serial monitor recording](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/reading.png)

![Sensor records less than 20cm](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/G.jpg)

![The serial monitor recording 20cm](../../../docs/manuals/assets/2.0/ultrasonic_Sensor/R.jpg)
