...
**Step 3:** let continue by ting the following codes;
   ...
   digitalWrite(2,HIGH);
   ```
![LED fixed on breadboard](../../../docs/manuals/assets/1.0/LED/FIVE_LEDs_Blink/coed_2.png).
...
![LED fixed on breadboard](../../../docs/manuals/assets/1.0/LED/FIVE_LEDs_Blink/observation.jpg).
