...
![inseting the buzzer](../../assets/2.0/2.1.Push Button + LED/4.LED/2.img_1.webp).

**step 2** Inset four (4) LEDs on the breadboard as shown in the picture below.
![inseting the buzzer](../../assets/2.0/2.1.Push Button + LED/4.LED/2.img_2.webp).
...
![inseting the buzzer](../../assets/2.0/2.1.Push Button + LED/4.LED/2.wire_1.webp).
...
![inseting the buzzer](../../assets/2.0/2.1.Push Button + LED/4.LED/2.wire_2.webp).
...
![inseting the buzzer](../../assets/2.0/2.1.Push Button + LED/4.LED/2.wire_8.webp).
...
![code 1](../../assets/2.0/2.1.Push Button + LED/4.LED/2.code_1.webp).
...
![code 2](../../assets/2.0/2.1.Push Button + LED/4.LED/2.code_2.webp).
...
![code 3](../../assets/2.0/2.1.Push Button + LED/4.LED/2.code_3.webp).
