# Project 145
## AUTOMATED WATER PUMP PROTECTION
...
| Water level sensor or float switch | 1 | Dry-run protection input | Use a 3.3V-safe switch arrangement |
| Push button | 2 | Manual start and protection reset | Use internal pull-ups |
| 1-channel relay module | 1 | Switches pump power | Verify active-low or active-high logic |
| Small DC pump or safe test load | 1 | Protected output | Use an external power supply |
| External power supply | 1 | Pump and relay power source | Match the pump rating |
| Green LED and 220 Ω resistor | 1 each | Ready-state indicator | Current-limited output only |
| Red LED and 220 Ω resistor | 1 each | Protection-latched indicator | Current-limited output only |
...
![Circuit Diagram](../../assets/intermidiate/AUTOMATED/AUTOMATED WATER PUMP PROTECTION/circuit_1.png)
