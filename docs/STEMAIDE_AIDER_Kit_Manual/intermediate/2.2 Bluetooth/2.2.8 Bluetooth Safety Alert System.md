...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![Analog safety sensor](../../../ASSETS/COMPONENTS/Analog_safety_sensor.png)<br>Analog safety sensor](../../../ASSETS/COMPONENTS/![Analog_safety_sensor](.._.._.._ASSETS_COMPONENTS_Analog_safety_sensor.png)<br>Analog_safety_sensor.png)<br>![Analog safety sensor](../../../ASSETS/COMPONENTS/Analog_safety_sensor.png)<br>Analog safety sensor | ![![Phone with BLE app](../../../ASSETS/COMPONENTS/Phone_with_BLE_app.png)<br>Phone with BLE app](../../../ASSETS/COMPONENTS/![Phone_with_BLE_app](.._.._.._ASSETS_COMPONENTS_Phone_with_BLE_app.png)<br>Phone_with_BLE_app.png)<br>![Phone with BLE app](../../../ASSETS/COMPONENTS/Phone_with_BLE_app.png)<br>Phone with BLE app | ![](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br> |
...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Analog safety sensor](../../../ASSETS/COMPONENTS/Analog_safety_sensor.png)<br>Analog safety sensor | ![Active buzzer](../../../ASSETS/COMPONENTS/Buzzer.png)<br>Active buzzer | ![Breadboard](../../../ASSETS/COMPONENTS/Breadboard.png)<br>Breadboard
