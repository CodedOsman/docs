...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![Analog safety sensor](../../../assets/aider/components/Analog_safety_sensor.png)<br>Analog safety sensor](../../../assets/aider/components/![Analog_safety_sensor](.._.._.._ASSETS_COMPONENTS_Analog_safety_sensor.png)<br>Analog_safety_sensor.png)<br>![Analog safety sensor](../../../assets/aider/components/Analog_safety_sensor.png)<br>Analog safety sensor | ![![Phone with BLE app](../../../assets/aider/components/Phone_with_BLE_app.png)<br>Phone with BLE app](../../../assets/aider/components/![Phone_with_BLE_app](.._.._.._ASSETS_COMPONENTS_Phone_with_BLE_app.png)<br>Phone_with_BLE_app.png)<br>![Phone with BLE app](../../../assets/aider/components/Phone_with_BLE_app.png)<br>Phone with BLE app | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> |
...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Analog safety sensor](../../../assets/aider/components/Analog_safety_sensor.png)<br>Analog safety sensor | ![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer | ![Breadboard](../../../assets/aider/components/Breadboard.png)<br>Breadboard
