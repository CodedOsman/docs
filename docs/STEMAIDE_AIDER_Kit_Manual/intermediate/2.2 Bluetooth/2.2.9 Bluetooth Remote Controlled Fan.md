...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![1-channel relay module or suitable driver stage](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>1-channel relay module or suitable driver stage](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>![1-channel relay module or suitable driver stage](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>1-channel relay module or suitable driver stage | ![![Phone with BLE app](../../../assets/aider/components/Phone_with_BLE_app.png)<br>Phone with BLE app](../../../assets/aider/components/![Phone_with_BLE_app](.._.._.._ASSETS_COMPONENTS_Phone_with_BLE_app.png)<br>Phone_with_BLE_app.png)<br>![Phone with BLE app](../../../assets/aider/components/Phone_with_BLE_app.png)<br>Phone with BLE app | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> |
...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![1-channel relay module or suitable driver stage](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>1-channel relay module or suitable driver stage | ![Low-voltage DC fan](../../../assets/aider/components/Low-voltage_DC_fan.png)<br>Low-voltage DC fan | ![External fan power supply](../../../assets/aider/components/External_fan_power_supply.png)<br>External fan power supply
