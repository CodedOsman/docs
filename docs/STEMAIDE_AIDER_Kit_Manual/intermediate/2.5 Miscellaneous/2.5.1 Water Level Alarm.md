...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![Water-level sensor (analog)](../../../assets/aider/components/Water-level_sensor_(analog).png)<br>Water-level sensor (analog)](../../../assets/aider/components/![Water-level_sensor_(analog)](.._.._.._ASSETS_COMPONENTS_Water-level_sensor_(analog).png)<br>Water-level_sensor_(analog).png)<br>![Water-level sensor (analog)](../../../assets/aider/components/Water-level_sensor_(analog).png)<br>Water-level sensor (analog) | ![![Phone with mobile app](../../../assets/aider/components/Phone_with_mobile_app.png)<br>Phone with mobile app](../../../assets/aider/components/![Phone_with_mobile_app](.._.._.._ASSETS_COMPONENTS_Phone_with_mobile_app.png)<br>Phone_with_mobile_app.png)<br>![Phone with mobile app](../../../assets/aider/components/Phone_with_mobile_app.png)<br>Phone with mobile app | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> |
...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Water-level sensor (analog)](../../../assets/aider/components/Water-level_sensor_(analog).png)<br>Water-level sensor (analog) | ![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer | ![Water container or tank](../../../assets/aider/components/Water_container_or_tank.png)<br>Water container or tank
![Breadboard and jumper wires](../../../assets/aider/components/Breadboard.png)<br>Breadboard and jumper wires | ![Phone with mobile app](../../../assets/aider/components/Phone_with_mobile_app.png)<br>Phone with mobile app | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>
