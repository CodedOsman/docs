...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![Water-level sensor (analog)](../../../ASSETS/COMPONENTS/Water-level_sensor_(analog).png)<br>Water-level sensor (analog)](../../../ASSETS/COMPONENTS/![Water-level_sensor_(analog)](.._.._.._ASSETS_COMPONENTS_Water-level_sensor_(analog).png)<br>Water-level_sensor_(analog).png)<br>![Water-level sensor (analog)](../../../ASSETS/COMPONENTS/Water-level_sensor_(analog).png)<br>Water-level sensor (analog) | ![![Phone with mobile app](../../../ASSETS/COMPONENTS/Phone_with_mobile_app.png)<br>Phone with mobile app](../../../ASSETS/COMPONENTS/![Phone_with_mobile_app](.._.._.._ASSETS_COMPONENTS_Phone_with_mobile_app.png)<br>Phone_with_mobile_app.png)<br>![Phone with mobile app](../../../ASSETS/COMPONENTS/Phone_with_mobile_app.png)<br>Phone with mobile app | ![](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br> |
...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Water-level sensor (analog)](../../../ASSETS/COMPONENTS/Water-level_sensor_(analog).png)<br>Water-level sensor (analog) | ![Active buzzer](../../../ASSETS/COMPONENTS/Buzzer.png)<br>Active buzzer | ![Water container or tank](../../../ASSETS/COMPONENTS/Water_container_or_tank.png)<br>Water container or tank
![Breadboard and jumper wires](../../../ASSETS/COMPONENTS/Breadboard.png)<br>Breadboard and jumper wires | ![Phone with mobile app](../../../ASSETS/COMPONENTS/Phone_with_mobile_app.png)<br>Phone with mobile app | ![](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br>
