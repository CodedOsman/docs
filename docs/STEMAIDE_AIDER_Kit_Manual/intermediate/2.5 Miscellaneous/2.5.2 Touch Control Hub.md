...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![Touch sensor module (TTP223 or similar)](../../../assets/aider/components/Touch_sensor_module__TTP223.png)<br>Touch sensor module (TTP223 or similar)](../../../assets/aider/components/Touch_sensor_module__TTP223.png)<br>![Touch sensor module (TTP223 or similar)](../../../assets/aider/components/Touch_sensor_module__TTP223.png)<br>Touch sensor module (TTP223 or similar) | ![![Phone with BLE app](../../../assets/aider/components/Phone_with_BLE_app.png)<br>Phone with BLE app](../../../assets/aider/components/![Phone_with_BLE_app](.._.._.._ASSETS_COMPONENTS_Phone_with_BLE_app.png)<br>Phone_with_BLE_app.png)<br>![Phone with BLE app](../../../assets/aider/components/Phone_with_BLE_app.png)<br>Phone with BLE app | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> |
...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Touch sensor module (TTP223 or similar)](../../../assets/aider/components/Touch_sensor_module__TTP223.png)<br>Touch sensor module (TTP223 or similar) | ![LEDs](../../../assets/aider/components/LEDs__single-color.png)<br>LEDs | ![220Ω resistors](../../../assets/aider/components/Resistors__220_Ohm.png)<br>220Ω resistors
