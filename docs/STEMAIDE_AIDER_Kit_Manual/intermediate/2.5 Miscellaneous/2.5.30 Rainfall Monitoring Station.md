...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![Pulse-output rain sensor or tipping-bucket rain gauge](../../../assets/aider/components/Raindrop_Detection_Module.png)<br>Pulse-output rain sensor or tipping-bucket rain gauge](../../../assets/aider/components/Raindrop_Detection_Module.png)<br>![Pulse-output rain sensor or tipping-bucket rain gauge](../../../assets/aider/components/Raindrop_Detection_Module.png)<br>Pulse-output rain sensor or tipping-bucket rain gauge | ![![Breadboard and jumper wires](../../../assets/aider/components/Breadboard.png)<br>Breadboard and jumper wires](../../../assets/aider/components/Breadboard.png)<br>![Breadboard and jumper wires](../../../assets/aider/components/Breadboard.png)<br>Breadboard and jumper wires | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> |
...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Pulse-output rain sensor or tipping-bucket rain gauge](../../../assets/aider/components/Raindrop_Detection_Module.png)<br>Pulse-output rain sensor or tipping-bucket rain gauge | ![Push button](../../../assets/aider/components/Push_buttons.png)<br>Push button | ![Blue LED and 220 Ω resistor](../../../assets/aider/components/LEDs__single-color.png)<br>Blue LED and 220 Ω resistor
