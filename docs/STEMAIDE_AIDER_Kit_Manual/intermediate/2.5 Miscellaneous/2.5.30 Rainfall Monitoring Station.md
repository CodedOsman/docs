...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![Pulse-output rain sensor or tipping-bucket rain gauge](../../../ASSETS/COMPONENTS/Raindrop_Detection_Module.png)<br>Pulse-output rain sensor or tipping-bucket rain gauge](../../../ASSETS/COMPONENTS/Raindrop_Detection_Module.png)<br>![Pulse-output rain sensor or tipping-bucket rain gauge](../../../ASSETS/COMPONENTS/Raindrop_Detection_Module.png)<br>Pulse-output rain sensor or tipping-bucket rain gauge | ![![Breadboard and jumper wires](../../../ASSETS/COMPONENTS/Breadboard.png)<br>Breadboard and jumper wires](../../../ASSETS/COMPONENTS/Breadboard.png)<br>![Breadboard and jumper wires](../../../ASSETS/COMPONENTS/Breadboard.png)<br>Breadboard and jumper wires | ![](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br> |
