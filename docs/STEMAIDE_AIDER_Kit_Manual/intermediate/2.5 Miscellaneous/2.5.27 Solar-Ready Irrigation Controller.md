...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Soil moisture sensor (analog output)](../../../assets/aider/components/Soil_Moisture_Sensor.png)<br>Soil moisture sensor (analog output) | ![LDR module with analog output](../../../assets/aider/components/LDR__light-dependent_resistor.png)<br>LDR module with analog output | ![Relay module or transistor relay driver](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>Relay module or transistor relay driver
