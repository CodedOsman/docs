...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![Water level sensor](../../../assets/aider/components/WaterLevelSensor.png)<br>Water level sensor](../../../assets/aider/components/WaterLevelSensor.png)<br>![Water level sensor](../../../assets/aider/components/WaterLevelSensor.png)<br>Water level sensor | ![![External pump power supply](../../../assets/aider/components/Water_Pumps.png)<br>External pump power supply](../../../assets/aider/components/Water_Pumps.png)<br>![External pump power supply](../../../assets/aider/components/Water_Pumps.png)<br>External pump power supply | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> |
