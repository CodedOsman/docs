...
| 1-channel relay module or suitable driver stage | 1 | Switches the fan power | Use a 3.3V-safe control input stage |
| Low-voltage DC fan | 1 | External airflow device | Use an external supply matched to the fan |
| External fan power supply | 1 | Powers the fan and relay module if required | Check polarity and voltage |
| Breadboard and jumper wires | 1 set | Control wiring | Keep wires clear of moving blades |
...
Project 110: Bluetooth Sensor Calibration Tool
