...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![Water level sensor or float switch](../../../assets/aider/components/WaterLevelSensor.png)<br>Water level sensor or float switch](../../../assets/aider/components/WaterLevelSensor.png)<br>![Water level sensor or float switch](../../../assets/aider/components/WaterLevelSensor.png)<br>Water level sensor or float switch | ![![External power supply](../../../assets/aider/components/External_power_supply.png)<br>External power supply](../../../assets/aider/components/![External_power_supply](.._.._.._ASSETS_COMPONENTS_External_power_supply.png)<br>External_power_supply.png)<br>![External power supply](../../../assets/aider/components/External_power_supply.png)<br>External power supply | ![![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>](../../../assets/aider/components/![](.._.._.._ASSETS_COMPONENTS_RASPBERRY_Pi_PICO_2_W.png)<br>.png)<br>![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> |
...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Water level sensor or float switch](../../../assets/aider/components/WaterLevelSensor.png)<br>Water level sensor or float switch | ![Push button](../../../assets/aider/components/Push_buttons.png)<br>Push button | ![1-channel relay module](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>1-channel relay module
![Small DC pump or safe test load](../../../assets/aider/components/Water_Pumps.png)<br>Small DC pump or safe test load | ![External power supply](../../../assets/aider/components/External_power_supply.png)<br>External power supply | ![Green LED and 220 Ω resistor](../../../assets/aider/components/LEDs__single-color.png)<br>Green LED and 220 Ω resistor | ![Red LED and 220 Ω resistor](../../../assets/aider/components/LEDs__single-color.png)<br>Red LED and 220 Ω resistor
