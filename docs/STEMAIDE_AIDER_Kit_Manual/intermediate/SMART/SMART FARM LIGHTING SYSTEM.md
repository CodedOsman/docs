...
| 1-channel relay module | 1 | Switches the light power path | Verify active-low or active-high logic |
| Low-voltage lamp or LED strip | 1 | Lighting output | Use an external supply |
| External power supply | 1 | Powers the light and relay module if required | Match the light rating |
| LED and 220 Ω resistor | 1 each | Lighting status indicator | Current-limited output only |
