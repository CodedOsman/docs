# Project 186
## SMART DRAINAGE BLOCKAGE DETECTOR
...
| Ultrasonic distance sensor | 1 | Measures distance from the top of the channel or pit to the water surface | Protect the Pico input if the echo signal is 5V |
| Green LED and 220Ω resistor | 1 each | Shows normal drainage state | Use current limiting |
| Yellow LED and 220Ω resistor | 1 each | Shows elevated water level that still appears to be moving | Use current limiting |
| Red LED and 220Ω resistor | 1 each | Shows suspected blockage | Use current limiting |
| Active buzzer | 1 | Sounds when blockage is confirmed | Use a 3.3V-safe buzzer or suitable driver |
...
![Circuit Diagram](../../assets/intermidiate/SMART/SMART DRAINAGE BLOCKAGE DETECTOR/circuit_1.png)
