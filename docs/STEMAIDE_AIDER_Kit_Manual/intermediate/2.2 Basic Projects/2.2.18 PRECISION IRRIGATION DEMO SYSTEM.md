...
| Soil moisture sensor (analog output) | 1 | Measures the soil condition before and after each dose | Keep the electronics section dry |
| Relay module or transistor relay driver | 1 | Controls the pump or valve output | Use external load power |
| Push button | 1 | Starts an immediate irrigation evaluation cycle | Use with Pico internal pull-up |
| Status LED and 220 Ω resistor | 1 each | Shows when the irrigation output is active | Use current limiting |
...
**Project 173: Automated Irrigation Scheduler**