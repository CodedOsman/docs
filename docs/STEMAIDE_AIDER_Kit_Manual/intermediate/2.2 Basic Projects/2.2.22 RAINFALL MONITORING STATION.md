...
| Pulse-output rain sensor or tipping-bucket rain gauge | 1 | Generates a digital pulse when rainfall is detected or a bucket tips | Mount only the sensing head outdoors or near water exposure |
| Push button | 1 | Resets the session total and event history | Use with Pico internal pull-up |
| Blue LED and 220 Ω resistor | 1 each | Shows active rainfall detection | Use current limiting |
| Red LED and 220 Ω resistor | 1 each | Shows heavy rainfall intensity | Use current limiting |
