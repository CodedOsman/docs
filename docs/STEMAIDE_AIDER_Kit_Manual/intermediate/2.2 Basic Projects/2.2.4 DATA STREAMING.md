...
| 10kΩ potentiometer | 1 | Safe analog test input | Middle pin goes to GPIO 26 |
| Breadboard and jumper wires | 1 set | Connections | Keep the analog wiring short |
| Phone with BLE app | 1 | Wireless data viewer | Use a BLE UART-style app |
