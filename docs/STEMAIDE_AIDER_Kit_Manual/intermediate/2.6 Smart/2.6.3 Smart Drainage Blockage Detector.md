...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Ultrasonic distance sensor](../../../assets/aider/components/Ultrasonic_sensor__HC-SR04.png)<br>Ultrasonic distance sensor | ![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer | ![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Green LED and 220Ω resistor](../../../assets/aider/components/LEDs__single-color.png)<br>Green LED and 220Ω resistor |
