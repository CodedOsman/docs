...
|  |  |  |  |
| --- | --- | --- | --- |
| ![1-channel relay module](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>1-channel relay module | <br>Phone with BLUETOOTH app | ![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | <br>Low-voltage test load |
| ![External load power supply](../../../assets/aider/components/9V_Battery.png)<br>External load power supply | ![Breadboard and jumper wires](../../../assets/aider/components/Breadboard.png)<br>Breadboard  |   |   |
...
![Circuit Diagram](../../../assets/aider/intermediate/smart/smart_plug/circuit_1.png)
