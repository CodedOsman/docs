...
|  |  |  |  |
| --- | --- | --- | --- |
| ![1-channel relay module](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>1-channel relay module | ![Phone with BLE app](../../../assets/aider/components/Phone_with_BLE_app.png)<br>Phone with BLE app | ![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Low-voltage test load](../../../assets/aider/components/Low-voltage_test_load.png)<br>Low-voltage test load |
| ![External load power supply](../../../assets/aider/components/External_load_power_supply.png)<br>External load power supply | ![Breadboard and jumper wires](../../../assets/aider/components/Breadboard.png)<br>Breadboard and jumper wires |   |   |
