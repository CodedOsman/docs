# Project 2.6.15: Smart Irrigation Failure Detection
...
|---|---|---|---|
| Soil moisture sensor VCC | 3.3V | Physical pin 36 | Use a 3.3V-safe sensor output. |
| Soil moisture sensor GND | GND | Any GND pin | Common ground |
| Soil moisture sensor AOUT | GPIO 26 | GPIO 26 / physical pin 31 | ADC soil-moisture input |
...
![Circuit Diagram](../../../assets/aider/intermediate/smart/smart_irrigation_failure_detection/circuit_1.png)
