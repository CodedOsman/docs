...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![Ultrasonic distance sensor](../../../assets/aider/components/Ultrasonic_distance_sensor.png)<br>Ultrasonic distance sensor](../../../assets/aider/components/![Ultrasonic_distance_sensor](.._.._.._ASSETS_COMPONENTS_Ultrasonic_distance_sensor.png)<br>Ultrasonic_distance_sensor.png)<br>![Ultrasonic distance sensor](../../../assets/aider/components/Ultrasonic_distance_sensor.png)<br>Ultrasonic distance sensor | ![![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer](../../../assets/aider/components/Buzzer.png)<br>![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> |
...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Ultrasonic distance sensor](../../../assets/aider/components/Ultrasonic_distance_sensor.png)<br>Ultrasonic distance sensor | ![Green LED and 220Ω resistor](../../../assets/aider/components/LEDs__single-color.png)<br>Green LED and 220Ω resistor | ![Yellow LED and 220Ω resistor](../../../assets/aider/components/LEDs__single-color.png)<br>Yellow LED and 220Ω resistor
![Red LED and 220Ω resistor](../../../assets/aider/components/LEDs__single-color.png)<br>Red LED and 220Ω resistor | ![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer | ![Breadboard and jumper wires](../../../assets/aider/components/Breadboard.png)<br>Breadboard and jumper wires | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>
