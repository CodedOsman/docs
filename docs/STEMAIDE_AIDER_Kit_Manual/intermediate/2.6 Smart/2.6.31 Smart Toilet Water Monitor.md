# Project 2.6.31: Smart Toilet Water Monitor
...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Water level sensor module](../../../assets/aider/components/WaterLevelSensor.png)<br>Water level sensor module | ![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer | ![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Push button](../../../assets/aider/components/Push_buttons.png)<br>Push button |
...
|---|---|---|---|
| Refill sensor VCC | 3.3V | Physical pin 36 | Use a 3.3V-safe sensor output. |
| Refill sensor GND | GND | Any GND pin | Common ground |
| Refill sensor AOUT | GPIO 26 | GPIO 26 / physical pin 31 | ADC refill-level input |
...
![Circuit Diagram](../../../assets/aider/intermediate/smart/smart_toilet_water_monitor/circuit_1.png)
