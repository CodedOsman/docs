...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![Water level sensor module](../../../assets/aider/components/WaterLevelSensor.png)<br>Water level sensor module](../../../assets/aider/components/WaterLevelSensor.png)<br>![Water level sensor module](../../../assets/aider/components/WaterLevelSensor.png)<br>Water level sensor module | ![![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer](../../../assets/aider/components/Buzzer.png)<br>![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> |
...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Water level sensor module](../../../assets/aider/components/WaterLevelSensor.png)<br>Water level sensor module | ![Push button](../../../assets/aider/components/Push_buttons.png)<br>Push button | ![Green LED and 220 Ω resistor](../../../assets/aider/components/LEDs__single-color.png)<br>Green LED and 220 Ω resistor
