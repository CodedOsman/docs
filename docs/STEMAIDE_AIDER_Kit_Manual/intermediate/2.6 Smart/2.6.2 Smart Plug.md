...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![1-channel relay module](../../../ASSETS/COMPONENTS/RELAY_SINGLE_CHANNEL.png)<br>1-channel relay module | ![Low-voltage test load](../../../ASSETS/COMPONENTS/Low-voltage_test_load.png)<br>Low-voltage test load | ![External load power supply](../../../ASSETS/COMPONENTS/External_load_power_supply.png)<br>External load power supply
