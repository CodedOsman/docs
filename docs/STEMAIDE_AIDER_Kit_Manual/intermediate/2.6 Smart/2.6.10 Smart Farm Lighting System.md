...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![LDR module with analog output](../../../assets/aider/components/LDR__light-dependent_resistor.png)<br>LDR module with analog output | ![1-channel relay module](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>1-channel relay module | ![Low-voltage lamp or LED strip](../../../assets/aider/components/LEDs__single-color.png)<br>Low-voltage lamp or LED strip
