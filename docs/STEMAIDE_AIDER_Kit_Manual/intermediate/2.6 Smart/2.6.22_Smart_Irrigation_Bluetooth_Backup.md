...
| --- | --- | --- | --- |
![Raspberry Pi Pico 2 W](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Soil moisture sensor (analog output)](../../../ASSETS/COMPONENTS/Soil_Moisture_Sensor.png)<br>Soil moisture sensor (analog output) | ![Relay module or transistor relay driver](../../../ASSETS/COMPONENTS/RELAY_SINGLE_CHANNEL.png)<br>Relay module or transistor relay driver | ![Status LED and 220 Ω resistor](../../../ASSETS/COMPONENTS/LEDs__single-color.png)<br>Status LED and 220 Ω resistor
![External pump or valve power supply](../../../ASSETS/COMPONENTS/Water_Pumps.png)<br>External pump or valve power supply | ![Breadboard and jumper wires](../../../ASSETS/COMPONENTS/Breadboard.png)<br>Breadboard and jumper wires | ![Phone with BLE app](../../../ASSETS/COMPONENTS/Phone_with_BLE_app.png)<br>Phone with BLE app | ![](../../../ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br>
