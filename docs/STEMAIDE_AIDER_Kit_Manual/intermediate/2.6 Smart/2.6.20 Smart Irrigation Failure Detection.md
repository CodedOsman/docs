...
|  |  |  |  |
| --- | --- | --- | --- |
| ![![Soil moisture sensor](../../../assets/aider/components/Soil_Moisture_Sensor.png)<br>Soil moisture sensor](../../../assets/aider/components/Soil_Moisture_Sensor.png)<br>![Soil moisture sensor](../../../assets/aider/components/Soil_Moisture_Sensor.png)<br>Soil moisture sensor | ![![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer](../../../assets/aider/components/Buzzer.png)<br>![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> | ![](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br> |
