# Project 2.2.5: Automated Water Pump Protection
...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Water level sensor or float switch](../../../assets/aider/components/WaterLevelSensor.png)<br>Water level sensor or float switch | ![External power supply](../../../assets/aider/components/9V_Battery.png)<br>External power supply | ![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Push button](../../../assets/aider/components/Push_buttons.png)<br>Push button |
