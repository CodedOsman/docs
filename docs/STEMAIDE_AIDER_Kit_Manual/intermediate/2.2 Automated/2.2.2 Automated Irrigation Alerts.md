# Project 2.2.2: Automated Irrigation Alerts
...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Soil moisture sensor](../../../assets/aider/components/Soil_Moisture_Sensor.png)<br>Soil moisture sensor | ![Buzzer](../../../assets/aider/components/Buzzer.png)<br>Buzzer | ![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![1-channel relay module](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>1-channel relay module |
| ![Small DC water pump](../../../assets/aider/components/Water_Pumps.png)<br>Small DC water pump | ![External power supply](../../../assets/aider/components/9V_Battery.png)<br>External power supply | ![LED and 220 Ω resistor](../../../assets/aider/components/LEDs__single-color.png)<br>LED and 220 Ω resistor | ![Phone or computer](../../../assets/aider/components/Phone_or_computer.png)<br>Phone or computer |
...
![Circuit Diagram](../../../assets/aider/intermediate/automated/automated_irregation_alert/circuit_1.png)
