# Project 2.1.29: Water Level Alarm
...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Phone with mobile app](../../../assets/aider/components/Phone_with_mobile_app.png)<br>Phone with mobile app | ![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer | ![Water-level sensor](../../../assets/aider/components/WaterLevelSensor.png)<br>Water-level sensor |
...
![Circuit Diagram](../../../assets/aider/intermediate/water_level_alarm/circuit_1.png)
