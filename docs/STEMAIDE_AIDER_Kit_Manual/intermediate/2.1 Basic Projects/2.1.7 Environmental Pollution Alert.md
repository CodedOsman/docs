# Project 2.1.7: Environmental Pollution Alert
...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Air-quality or gas-proxy sensor module](../../../assets/aider/components/Gas_sensor.png)<br>Air-quality or gas-proxy sensor module | ![Breadboard and jumper wires](../../../assets/aider/components/Breadboard.png)<br>Breadboard and jumper wires | ![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Yellow LED and 220 Ω resistor](../../../assets/aider/components/LEDs__single-color.png)<br>Yellow LED and 220 Ω resistor |
| ![Red LED and 220 Ω resistor](../../../assets/aider/components/LEDs__single-color.png)<br>Red LED and 220 Ω resistor | ![Active buzzer](../../../assets/aider/components/Buzzer.png)<br>Active buzzer |   |   |
...
![Circuit Diagram](../../../assets/aider/intermediate/environmental_pollution_alert/circuit_1.png)
