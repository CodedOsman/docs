# Project 2.1.14: Multi Sensor Dashboard
...
|  |  |  |  |
| --- | --- | --- | --- |
| ![BME280 sensor module](../../../assets/aider/components/BME280_Sensor.png)<br>BME280 sensor module | ![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Soil moisture sensor](../../../assets/aider/components/Soil_Moisture_Sensor.png)<br>Soil moisture sensor | ![Breadboard and jumper wires](../../../assets/aider/components/Breadboard.png)<br>Breadboard and jumper wires |
...
![Circuit Diagram](../../../assets/aider/intermediate/multi_sensor_dashdoard/circuit_1.png)
