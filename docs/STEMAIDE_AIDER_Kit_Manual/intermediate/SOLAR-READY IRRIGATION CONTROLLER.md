...
| Soil moisture sensor (analog output) | 1 | Measures irrigation need | Keep the electronics section dry |
...
| Push button | 1 | Runs a short manual test cycle | Use with Pico internal pull-up |
| Green LED and 220 Ω resistor | 1 each | Shows solar-ready state | Use current limiting |
| Yellow LED and 220 Ω resistor | 1 each | Shows pending irrigation state | Use current limiting |
