# Project 3.4.7: Environmental Iot Hub
...
- This environmental IoT hub is a local prototype node and not a complete cloud platform.
...
```
project_240_environmental_iot_hub.py
```
...
**Project 241: Flood Threshold Alarm**