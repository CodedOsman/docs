...
|  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../docs/ASSETS/COMPONENTS/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Gas sensor](../../ASSETS/COMPONENTS/Gas_sensor.png)<br>Gas sensor | ![Breadboard](../../ASSETS/COMPONENTS/Breadboard.png)<br>Breadboard | ![Jumper Wires](../../ASSETS/COMPONENTS/Jumper_Wire_male_to_female__M_M__M_F.png)<br>Jumper wires |
| ![LED](../../docs/ASSETS/COMPONENTS/LEDs__single-color.png)<br>LED | ![Resistor](../../docs/ASSETS/COMPONENTS/Resistors__220_Ohm.png)<br>Resistor |![Motion sensor](../../ASSETS/COMPONENTS/PIR_SENSOR__MOTION_SENSOR.png)<br> Motion sensor|  |  |  |
