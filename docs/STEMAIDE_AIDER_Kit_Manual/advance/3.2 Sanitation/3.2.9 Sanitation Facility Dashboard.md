...
| ![LED](../../docs/ASSETS/COMPONENTS/LEDs__single-color.png)<br>LED | ![Resistor](../../docs/ASSETS/COMPONENTS/Resistors__220_Ohm.png)<br>Resistor |![Gas sensor](../../ASSETS/COMPONENTS/Gas_sensor.png)<br> Gas sensor |  |  |  |
...
```
project_236_sanitation_facility_dashboard.py
```
...
**Project 237: Environmental Compliance**