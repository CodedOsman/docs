...
| ![LED](../../docs/ASSETS/COMPONENTS/LEDs__single-color.png)<br>LED | ![Resistor](../../docs/ASSETS/COMPONENTS/Resistors__220_Ohm.png)<br>Resistor | ![Buzzer](../../ASSETS/COMPONENTS/Buzzer.png)<br> Buzzern |  |  |  |
---
...
```
project_239_sanitation_awareness_system.py
```
...
**Project 240: Environmental IoT Hub**