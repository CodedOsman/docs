...
Water-level dashboards can support early monitoring at a river or bridge point when users understand how the distance reading maps to actual risk.
...
```
project_202_river_level_monitor.py
```
...
**Project 203: Waste Sorting Demo**