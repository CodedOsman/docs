# Project 3.8.3: Water Safety Alarm
...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Turbidity sensor](../../../assets/aider/components/water_quality_sensor.png)<br>Turbidity sensor | ![Breadboard](../../../assets/aider/components/Breadboard.png)<br>Breadboard | ![Jumper wires](../../../assets/aider/components/Jumper_Wire_male_to_female__M_M__M_F.png)<br>Jumper wires |
...
![Circuit Diagram](../../../assets/aider/advance/water_safety_alarm/circuit_1.png)
