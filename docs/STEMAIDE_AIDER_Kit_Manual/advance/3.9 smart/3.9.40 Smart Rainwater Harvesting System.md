# Project 3.9.40: Smart Rainwater Harvesting System
...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Raspberry Pi Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Rain Senor](../../../assets/aider/components/Raindrop_Detection_Module.png)<br>Rain Senor | ![Breadboard](../../../assets/aider/components/Breadboard.png)<br>Breadboard | ![Jumper wires](../../../assets/aider/components/Jumper_Wire_male_to_female__M_M__M_F.png)<br>Jumper wires |
| ![Single Channel Relay](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>Single Channel Relay | ![LED](../../../assets/aider/components/LEDs__single-color.png)<br>LED | ![Resistor](../../../assets/aider/components/Resistors__220_Ohm.png)<br>Resistor | ![Water Level Sensor](../../../assets/aider/components/WaterLevelSensor.png)<br>Water Level Sensor |
---
...
![Circuit Diagram](../../../assets/aider/advance/smart/smart_rainwater_harvesting_system/smart rain harvesting system 195.png)
