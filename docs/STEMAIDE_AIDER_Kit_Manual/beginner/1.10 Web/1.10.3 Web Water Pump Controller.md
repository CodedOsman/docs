...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Water Pump](../../../assets/aider/components/Water_Pumps.png)<br>Small DC water pump | ![Relay Module](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>1-channel relay module | ![Water Level Sensor](../../../assets/aider/components/WaterLevelSensor.png)<br>Water level sensor |
| 1N4007 diode | ![OLED Display](../../../assets/aider/components/OLED_Displays.png)<br>SH1106 OLED display | External power supply | ![Breadboard](../../../assets/aider/components/Breadboard.png)<br>Breadboard |
...
![Circuit 2](../../../assets/aider/beginner/web/web_water_pump_controller/circuit_2.png)
...
![Circuit 3](../../../assets/aider/beginner/web/web_water_pump_controller/circuit_3.png)
...
![Circuit 4](../../../assets/aider/beginner/web/web_water_pump_controller/circuit_4.png)
...
![Circuit 5](../../../assets/aider/beginner/web/web_water_pump_controller/circuit_5.png)
...
![Circuit 6](../../../assets/aider/beginner/web/web_water_pump_controller/circuit_6.png)
...
![Circuit 7](../../../assets/aider/beginner/web/web_water_pump_controller/circuit_7.png)

### Step 7: Add the Flyback Diode

Connect pump negative terminal to external pump supply negative.

![Circuit 8](../../../assets/aider/beginner/web/web_water_pump_controller/circuit_8.png)
...
âœ“ Water sensor VCC connects to 3.3V

âœ“ Water sensor GND connects to GND

âœ“ Water sensor AOUT connects to GPIO 26
...
âœ“ External pump supply positive connects to relay COM

âœ“ Relay NO connects to pump positive terminal
