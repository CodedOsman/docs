...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Push Button](../../../assets/aider/components/Push_buttons.png)<br>Push button | PIR motion sensor | ![LED](../../../assets/aider/components/LEDs__single-color.png)<br>LED |
| ![Resistor](../../../assets/aider/components/Resistors__220_Ohm.png)<br>220Î© resistor | ![BME280](../../../assets/aider/components/BME280_Sensor.png)<br>BME280 module | ![Breadboard](../../../assets/aider/components/Breadboard.png)<br>Breadboard | ![Jumper Wires](../../../assets/aider/components/Jumper_Wire_male_to_female__M_M__M_F.png)<br>Jumper wires |
...
| LED anode (+) | 220Î© resistor then GPIO 0 | GPIO 0 / physical pin 1 |  |
...
![Circuit 2](../../../assets/aider/beginner/iot/iot_classroom_demo_board/circuit_2.png)
...
![Circuit 3](../../../assets/aider/beginner/iot/iot_classroom_demo_board/circuit_3.png)
...
![Circuit 4](../../../assets/aider/beginner/iot/iot_classroom_demo_board/circuit_4.png)
...
![Circuit 5](../../../assets/aider/beginner/iot/iot_classroom_demo_board/circuit_5.png)
...
![Circuit 6](../../../assets/aider/beginner/iot/iot_classroom_demo_board/circuit_6.png)
...
![Circuit 7](../../../assets/aider/beginner/iot/iot_classroom_demo_board/circuit_7.png)

## Wiring Check

âœ“ Pico 2W is placed correctly across the breadboard center gap

âœ“ Push button connects to GPIO 1 and GND

âœ“ PIR VCC connects to 3.3V or a module-safe supply

âœ“ PIR GND connects to GND

âœ“ PIR OUT connects to GPIO 2
