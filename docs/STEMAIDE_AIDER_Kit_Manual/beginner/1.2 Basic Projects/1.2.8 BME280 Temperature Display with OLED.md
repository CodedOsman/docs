...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![BME280](../../../assets/aider/components/BME280_Sensor.png)<br>BME280 module | ![OLED Display](../../../assets/aider/components/OLED_Displays.png)<br>SH1106 OLED display | ![Breadboard](../../../assets/aider/components/Breadboard.png)<br>Breadboard |
...
# Shared I2C bus for the BME280 and OLED
i2c = I2C(0, sda=Pin(8), scl=Pin(9), freq=400000)
...
while True:
    ...
    oled.fill(0)
    oled.text('BME280 SENSOR', 0, 0)
    oled.text('Temp: ' + temperature, 0, 18)
    oled.text('Press:' + pressure, 0, 34)
    oled.text('Hum: ' + humidity, 0, 50)
    oled.show()
