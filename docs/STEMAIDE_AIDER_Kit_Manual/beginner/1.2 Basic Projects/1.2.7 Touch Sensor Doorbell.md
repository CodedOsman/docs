...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../assets/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Touch Sensor](../../assets/components/Touch_sensor_module__TTP223.png)<br>TTP223 touch sensor | ![Buzzer](../../assets/components/Buzzer.png)<br>Active buzzer | ![Breadboard](../../assets/components/Breadboard.png)<br>Breadboard |
...
![Circuit 2](../../assets/beginner/TOUCH SENSOR DOORBELL/circuit_2.png)
...
![Circuit 3](../../assets/beginner/TOUCH SENSOR DOORBELL/circuit_3.png)

### Step 3: Connect the Touch Sensor VCC

Connect the touch sensor VCC pin to 3.3V.

![Circuit 4](../../assets/beginner/TOUCH SENSOR DOORBELL/circuit_4.png)

### Step 4: Connect the Touch Sensor GND

Connect the touch sensor GND pin to GND.

![Circuit 5](../../assets/beginner/TOUCH SENSOR DOORBELL/circuit_5.png)
...
![Circuit 6](../../assets/beginner/TOUCH SENSOR DOORBELL/circuit_6.png)
...
![Circuit 7](../../assets/beginner/TOUCH SENSOR DOORBELL/circuit_7.png)
...
![Circuit 8](../../assets/beginner/TOUCH SENSOR DOORBELL/circuit_8.png)
...
Project 18: IR Obstacle Detection
