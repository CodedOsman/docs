...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../assets/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![LED](../../assets/components/LEDs__single-color.png)<br>LED | ![Resistor](../../assets/components/Resistors__220_Ohm.png)<br>220 ohm resistor | ![Potentiometer](../../assets/components/POTENTIOMETER__VARIABLE_RESISTOR.png)<br>Potentiometer |
| ![Breadboard](../../assets/components/Breadboard.png)<br>Breadboard | ![Jumper Wires](../../assets/components/Jumper_Wire_male_to_female__M_M__M_F.png)<br>Jumper wires | Computer with Thonny |  |
...
![Circuit 2](../../assets/beginner/PWM LED BRIGHTNESS CONTROL/circuit_2.png)
...
![Circuit 3](../../assets/beginner/PWM LED BRIGHTNESS CONTROL/circuit_3.png)
...
![Circuit 4](../../assets/beginner/PWM LED BRIGHTNESS CONTROL/circuit_4.png)

### Step 4: Connect the LED to GND

Connect the LED negative leg to GND.

![Circuit 5](../../assets/beginner/PWM LED BRIGHTNESS CONTROL/circuit_5.png)
...
![Circuit 6](../../assets/beginner/PWM LED BRIGHTNESS CONTROL/circuit_6.png)
...
![Circuit 7](../../assets/beginner/PWM LED BRIGHTNESS CONTROL/circuit_7.png)
