...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Color Sensor](../../../assets/aider/components/Color_sensor.png)<br>TCS3200 color sensor module | ![OLED Display](../../../assets/aider/components/OLED_Displays.png)<br>SH1106 OLED display | ![Breadboard](../../../assets/aider/components/Breadboard.png)<br>Breadboard |
| ![Jumper Wires](../../../assets/aider/components/Jumper_Wire_male_to_female__M_M__M_F.png)<br>Jumper wires | White paper or colored object |  |  |
...
![Circuit 2](../../../assets/aider/beginner/color_detection_system/circuit_2.png)
...
![Circuit 3](../../../assets/aider/beginner/color_detection_system/circuit_3.png)
...
![Circuit 4](../../../assets/aider/beginner/color_detection_system/circuit_4.png)
...
![Circuit 5](../../../assets/aider/beginner/color_detection_system/circuit_5.png)

### Step 5:  Connect TCS3200 Output Pin

Connect TCS3200 OUT to GPIO 6.

![Circuit 6](../../../assets/aider/beginner/color_detection_system/circuit_6.png)
...
![Circuit 7](../../../assets/aider/beginner/color_detection_system/circuit_7.png)
...
![Circuit 8](../../../assets/aider/beginner/color_detection_system/circuit_8.png)
...
# TCS3200 control and output pins
s0 = Pin(2, Pin.OUT)
s1 = Pin(3, Pin.OUT)
s2 = Pin(4, Pin.OUT)
s3 = Pin(5, Pin.OUT)
...
# Set sensor output frequency scaling to 20%.
s0.on()
s1.off()

print('TCS3200 color detector ready')
...
def count_pulses(duration_ms=100):
    count = 0
    start = time.ticks_ms()
...
while True:
    ...
    display.fill(0)
    display.text('Color Detect', 14, 0, 1)
    display.text('Color: ' + color_name, 0, 16, 1)
    display.text('R:{} G:{}'.format(red, green), 0, 34, 1)
    display.text('B:{}'.format(blue), 0, 50, 1)
    display.show()

    print('Color:', color_name, '| R:', red, 'G:', green, 'B:', blue)
    time.sleep(0.5)
```
