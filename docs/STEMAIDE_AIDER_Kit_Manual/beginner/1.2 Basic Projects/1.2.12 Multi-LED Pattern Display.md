...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![LED](../../../assets/aider/components/LEDs__single-color.png)<br>LEDs | ![Resistor](../../../assets/aider/components/Resistors__220_Ohm.png)<br>220Ω resistors | ![Breadboard](../../../assets/aider/components/Breadboard.png)<br>Breadboard |
...
![Circuit 2](../../../assets/aider/beginner/multi-led_pattern_display/circuit_2.png)
...
![Circuit 3](../../../assets/aider/beginner/multi-led_pattern_display/circuit_3.png)
...
![Circuit 4](../../../assets/aider/beginner/multi-led_pattern_display/circuit_4.png)

### Step 4: Connect LED 1 to GPIO 0

Connect the free end of LED 1's resistor to GPIO 0.

![Circuit 5](../../../assets/aider/beginner/multi-led_pattern_display/circuit_5.png)

### Step 5: Connect LED 2 to GPIO 1

Connect the free end of LED 2's resistor to GPIO 1.

![Circuit 6](../../../assets/aider/beginner/multi-led_pattern_display/circuit_6.png)

### Step 6: Connect LED 3 to GPIO 2

Connect the free end of LED 3's resistor to GPIO 2.

![Circuit 7](../../../assets/aider/beginner/multi-led_pattern_display/circuit_7.png)

### Step 7: Connect LED 4 to GPIO 3

Connect the free end of LED 4's resistor to GPIO 3.

![Circuit 8](../../../assets/aider/beginner/multi-led_pattern_display/circuit_8.png)

### Step 8: Connect LED 5 to GPIO 4

Connect the free end of LED 5's resistor to GPIO 4.

![Circuit 9](../../../assets/aider/beginner/multi-led_pattern_display/circuit_9.png)

### Step 9: Connect LED 6 to GPIO 5

Connect the free end of LED 6's resistor to GPIO 5.

![Circuit 10](../../../assets/aider/beginner/multi-led_pattern_display/circuit_10.png)

### Step 10: Connect LED 7 to GPIO 6

Connect the free end of LED 7's resistor to GPIO 6.

![Circuit 11](../../../assets/aider/beginner/multi-led_pattern_display/circuit_11.png)

### Step 11: Connect LED 8 to GPIO 7

Connect the free end of LED 8's resistor to GPIO 7.

![Circuit 12](../../../assets/aider/beginner/multi-led_pattern_display/circuit_12.png)
...
![Circuit 13](../../../assets/aider/beginner/multi-led_pattern_display/circuit_13.png)
