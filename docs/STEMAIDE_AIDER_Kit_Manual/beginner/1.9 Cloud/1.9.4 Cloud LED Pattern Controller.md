...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![LED](../../../assets/aider/components/LEDs__single-color.png)<br>LEDs | ![Resistor](../../../assets/aider/components/Resistors__220_Ohm.png)<br>220Î© resistors | ![Breadboard](../../../assets/aider/components/Breadboard.png)<br>Breadboard |
...
| --- | --- | --- | --- |
| LED 1 anode (+) | 220Î© resistor then GPIO 0 | GPIO 0 / physical pin 1 |  |
| LED 2 anode (+) | 220Î© resistor then GPIO 1 | GPIO 1 / physical pin 2 |  |
| LED 3 anode (+) | 220Î© resistor then GPIO 2 | GPIO 2 / physical pin 4 |  |
| LED 4 anode (+) | 220Î© resistor then GPIO 3 | GPIO 3 / physical pin 5 |  |
...
![Circuit 2](../../../assets/aider/beginner/cloud/cloud_led_pattern_controller/circuit_2.png)
...
![Circuit 3](../../../assets/aider/beginner/cloud/cloud_led_pattern_controller/circuit_3.png)

### Step 3: Add One 220Î© Resistor to Each LED

Connect one 220Î© resistor to the long leg of each LED.

Each LED must have its own resistor.

![Circuit 4](../../../assets/aider/beginner/cloud/cloud_led_pattern_controller/circuit_4.png)

### Step 4: Connect LED 1 to GPIO 0

Connect the free end of LED 1's resistor to GPIO 0.

![Circuit 5](../../../assets/aider/beginner/cloud/cloud_led_pattern_controller/circuit_5.png)

### Step 5: Connect LED 2 to GPIO 1

Connect the free end of LED 2's resistor to GPIO 1.

![Circuit 6](../../../assets/aider/beginner/cloud/cloud_led_pattern_controller/circuit_6.png)

### Step 6: Connect LED 3 to GPIO 2

Connect the free end of LED 3's resistor to GPIO 2.

![Circuit 7](../../../assets/aider/beginner/cloud/cloud_led_pattern_controller/circuit_7.png)

### Step 7: Connect LED 4 to GPIO 3

Connect the free end of LED 4's resistor to GPIO 3.

![Circuit 8](../../../assets/aider/beginner/cloud/cloud_led_pattern_controller/circuit_8.png)

### Step 8: Connect All LED Short Legs to GND

Connect each LED short leg to GND.

![Circuit 9](../../../assets/aider/beginner/cloud/cloud_led_pattern_controller/circuit_9.png)

## Wiring Check

âœ“ Pico 2W is placed correctly across the breadboard center gap

âœ“ LED 1 long leg connects through a 220Î© resistor to GPIO 0

âœ“ LED 2 long leg connects through a 220Î© resistor to GPIO 1

âœ“ LED 3 long leg connects through a 220Î© resistor to GPIO 2

âœ“ LED 4 long leg connects through a 220Î© resistor to GPIO 3

âœ“ All LED short legs connect to GND
