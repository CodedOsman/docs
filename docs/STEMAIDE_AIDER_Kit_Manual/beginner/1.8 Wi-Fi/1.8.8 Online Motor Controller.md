...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Relay Module](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>1-channel relay module | ![DC Motor](../../../assets/aider/components/DC3-6V_130_Motor_DIY_Rotate_Speed.png)<br>Small DC motor | External power supply |
