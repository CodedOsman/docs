...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../assets/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Soil Moisture Sensor](../../assets/components/Soil_Moisture_Sensor.png)<br>Soil moisture sensor | ![LED](../../assets/components/LEDs__single-color.png)<br>Red LED | ![LED](../../assets/components/LEDs__single-color.png)<br>Green LED |
| ![Resistor](../../assets/components/Resistors__220_Ohm.png)<br>220Ω resistors | ![Breadboard](../../assets/components/Breadboard.png)<br>Breadboard | ![Jumper Wires](../../assets/components/Jumper_Wire_male_to_female__M_M__M_F.png)<br>Jumper wires |  |
...
![Circuit 2](../../assets/beginner/SOIL MOISTURE LED INDICATOR/circuit_2.png)
...
![Circuit 6](../../assets/beginner/SOIL MOISTURE LED INDICATOR/circuit_6.png)
...
![Circuit 7](../../assets/beginner/SOIL MOISTURE LED INDICATOR/circuit_7.png)
...
![Circuit 8](../../assets/beginner/SOIL MOISTURE LED INDICATOR/circuit_8.png)

### Step 8: Connect the Red LED to GPIO 0

Connect the free end of the red LED resistor to GPIO 0 on the Raspberry Pi Pico 2W.

![Circuit 9](../../assets/beginner/SOIL MOISTURE LED INDICATOR/circuit_9.png)
...
![Circuit 10](../../assets/beginner/SOIL MOISTURE LED INDICATOR/circuit_10.png)
...
![Circuit 11](../../assets/beginner/SOIL MOISTURE LED INDICATOR/circuit_11.png)
...
Project 16: Rain Detection Buzzer Alert
