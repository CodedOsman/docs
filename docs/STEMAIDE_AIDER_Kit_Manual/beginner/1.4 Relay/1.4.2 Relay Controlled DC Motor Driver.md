...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../../assets/aider/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![Relay Module](../../../assets/aider/components/RELAY_SINGLE_CHANNEL.png)<br>1-channel relay module | ![DC Motor](../../../assets/aider/components/DC3-6V_130_Motor_DIY_Rotate_Speed.png)<br>DC motor | ![Push Button](../../../assets/aider/components/Push_buttons.png)<br>Push button |
| ![Battery](../../../assets/aider/components/9V_Battery.png)<br>External motor supply | ![Breadboard](../../../assets/aider/components/Breadboard.png)<br>Breadboard | ![Jumper Wires](../../../assets/aider/components/Jumper_Wire_male_to_female__M_M__M_F.png)<br>Jumper wires |  |
