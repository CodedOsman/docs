...
![Circuit 1](../../../assets/aider/beginner/OLED/oled_countdown_timer/circuit_1.png)
...
# OLED uses GPIO 16 for SDA and GPIO 17 for SCL.
i2c = I2C(0, sda=Pin(16), scl=Pin(17), freq=400000)
display = sh1106.SH1106_I2C(128, 64, i2c)

# Push button on GPIO 2.
button = Pin(2, Pin.IN, Pin.PULL_UP)

def draw_screen(message, seconds=None):
    display.fill(0)
    display.text('COUNTDOWN', 20, 10, 1)
    display.text('TIMER', 38, 22, 1)
    if seconds is None:
        display.text(message, 35, 45, 1)
    else:
        display.text(str(seconds) + ' sec', 30, 45, 1)
    display.show()

draw_screen('READY')
print('Countdown timer ready')
