...
|  |  |  |  |
| --- | --- | --- | --- |
| ![Pico 2 W](../../../assets/components/RASPBERRY_Pi_PICO_2_W.png)<br>Raspberry Pi Pico 2 W | ![IR Receiver](../../../assets/components/IR_RECEIVER.png)<br>IR receiver module | ![Buzzer](../../../assets/components/Buzzer.png)<br>Active buzzer | ![Breadboard](../../../assets/components/Breadboard.png)<br>Breadboard |
...
![Step 1](../../../assets/beginner/IR/IR REMOTE BUZZER CONTROLLER/circuit_2.png)
...
![Step 2](../../../assets/beginner/IR/IR REMOTE BUZZER CONTROLLER/circuit_3.png)
...
![Step 3](../../../assets/beginner/IR/IR REMOTE BUZZER CONTROLLER/circuit_4.png)
...
![Step 4](../../../assets/beginner/IR/IR REMOTE BUZZER CONTROLLER/circuit_5.png)
...
![Step 5](../../../assets/beginner/IR/IR REMOTE BUZZER CONTROLLER/circuit_6.png)
...
![Step 6](../../../assets/beginner/IR/IR REMOTE BUZZER CONTROLLER/circuit_7.png)
...
![Step 7](../../../assets/beginner/IR/IR REMOTE BUZZER CONTROLLER/circuit_8.png)
...
![Step 8](../../../assets/beginner/IR/IR REMOTE BUZZER CONTROLLER/circuit_9.png)
...
Project 10: Touch Sensor LED Switch
...
- Pico 2 W digram
- | Project-Specific Safety Note If the buzzer needs more current than a GPIO pin can safely supply, use a transistor driver. Beginner Extension Project: This project is more advanced than the earlier beginner projects. Complete the basic projects first before attempting this one. |
- | Diagram Placeholder [Insert wiring diagram or breadboard image here] |
- 1. Connect the IR receiver VCC, GND, and OUT pins.
- 2. Connect the OUT pin to GPIO 1.
- 3. Place the active buzzer on the breadboard.
- 4. Connect the buzzer positive pin to GPIO 0.
- 5. Connect the buzzer negative pin to GND.
