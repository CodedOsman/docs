...
| Container with water | 2.4 GHz Wi-Fi network | Phone or computer browser |  |
...
![Step 1](../../../assets/beginner/WATER LEVEL/WATER LEVEL STATUS WEBPAGE/circuit_2.png)
...
![Step 2](../../../assets/beginner/WATER LEVEL/WATER LEVEL STATUS WEBPAGE/circuit_3.png)
...
![Step 3](../../../assets/beginner/WATER LEVEL/WATER LEVEL STATUS WEBPAGE/circuit_4.png)
...
![Step 4](../../../assets/beginner/WATER LEVEL/WATER LEVEL STATUS WEBPAGE/circuit_5.png)
...
Project 39: Soil Moisture Cloud Display
...
- Check that the analog reading changes when the sensor gets wet.
- Check that the Pico connects to Wi-Fi and prints its IP address.
- | Calibration values | Store dry and wet ADC readings | These let the raw sensor value become a percentage |
- | read_percentage() | Reads the sensor and maps it to 0-100% | Students can understand the water level more easily |
- | status_text() | Assigns a simple status and color | The page becomes easier to read at a glance |
- | web_page() | Builds the browser page with a simple visual tank | This turns the number into a clearer visual display |
- - Also show the raw ADC value and a text label such as EMPTY, MID, or FULL
