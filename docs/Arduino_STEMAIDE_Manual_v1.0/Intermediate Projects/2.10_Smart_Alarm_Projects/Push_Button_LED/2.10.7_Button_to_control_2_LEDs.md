...
![inseting push button](../../../../assets/2.0/2.1.Push Button + LED/2.LED/image_1.webp).

**step 2:** Inset two (2) LED s on the breadboard as shown in the picture below.
![inseting the buzzer](../../../../assets/2.0/2.1.Push Button + LED/2.LED/image_2.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.Push Button + LED/2.LED/wire_1.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.Push Button + LED/2.LED/wire_2.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.Push Button + LED/2.LED/wire_3.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.Push Button + LED/2.LED/wire_4.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.Push Button + LED/2.LED/wire_5.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.Push Button + LED/2.LED/wire_6.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.Push Button + LED/2.LED/code_1.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.Push Button + LED/2.LED/code_2.webp).
...
![inseting the buzzer](../../../../assets/2.0/2.1.Push Button + LED/2.LED/code_3.webp).
