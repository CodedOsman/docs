...
![Picture4](../../../assets/2.0/7.3.SoundSensor + Traffic/Wiringpic2.webp)
...
![Programpic1](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic1.webp)
...
![Programpic2](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic2.webp)
...
![Programpic3](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic3.webp)

**Step 5:** Type ``` const int greenPin = 7; ``` as shown below in the image.

![Programpic4](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic4.webp)
...
![Programpic5](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic5.webp)

**Step 7:** In the { } after the void setup (), Type ``` Serial.begin(9600); ``` as shown below in the image.

![Programpic6](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic6.webp)
...
![Programpic7](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic7.webp)
...
![Programpic8](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic8.webp)

**Step 10:** Type ``` if (soundValue > 100) {  } ; ``` as shown below in the image.

![Programpic9](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic9.webp)
...
![Programpic10](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic10.webp)
...
![Programpic11](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic11.webp)
...
![Programpic12](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic12.webp)
...
![Programpic13](../../../assets/2.0/7.3.SoundSensor + Traffic/Programphic13.webp)
