...
![TrafficLightModule fixed on breadboard](../../../assets/2.0/2.4. PushButton + RGB Module/circuit_2.png).
...
![LED fixed on breadboard](../../../assets/2.0/2.4. PushButton + RGB Module/circuit_3.png)
...
![LED fixed on breadboard](../../../assets/2.0/2.4. PushButton + RGB Module/picture4.webp). -->
...
![LED fixed on breadboard](../../../assets/2.0/2.4. PushButton + RGB Module/picture5.webp). -->
...
![LED fixed on breadboard](../../../assets/2.0/2.4. PushButton + RGB Module/picture6.webp). -->
...
![LED fixed on breadboard](../../../assets/2.0/2.4. PushButton + RGB Module/picture7.webp). -->
...
![LED fixed on breadboard](../../../assets/2.0/2.4. PushButton + RGB Module/picture8.webp). -->
...
![LED fixed on breadboard](../../../assets/2.0/2.3. PushButton + TrafficLightModule/Picture9.webp).
...
![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/code7.webp).
...
```
![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/code8.webp).
...
![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/code9.webp).
...
![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/code10.webp).
...
![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/code11.webp).
...
![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/code12.webp).
...
![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/code14.webp).
...
![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/code15.webp).
...
![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/code16.webp).
...
![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/code17.webp).
...
![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/code18.webp).
...
![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/picture9.webp).

![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/picture10.webp).

![Pinmode decalration](../../../assets/2.0/2.4. PushButton + RGB Module/picture11.webp).
