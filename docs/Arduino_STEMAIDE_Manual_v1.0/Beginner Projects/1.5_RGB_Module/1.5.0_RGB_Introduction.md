...
> [!IMPORTANT]
> The STEMAIDE Coder-Kit contains a **Common Cathode** RGB module. In this manual, all wiring diagrams and programming codes assume the Common pin connects to **GND** on the Arduino Uno.
