...
|------------------|----------------------------------------------------------------|
| **Use case**     | This project is connected to real-world uses such as flood monitoring, wildfire detection, and industrial safety applications. It demonstrates how environmental conditions can be monitored continuously to provide early warnings. |

## Components (Things You will need)

| ![Arduino Uno](../../assets/coder_pro/components/arduino.webp) | ![Bread Board](../../assets/coder_pro/components/breadboard.webp) | ![Arduino USB Cable](../../assets/coder_pro/components/usbcable.webp) | ![Jumper Wires](../../assets/coder_pro/components/jumperwires.webp) | ![Water Level Sensor](../../assets/coder_pro/components/watersensor.jpg) | ![Temperature Sensor](../../assets/coder_pro/components/temperaturesensor.webp) | ![LCD Display](../../assets/coder_pro/components/lcdscreen.jpg) | ![LED](../../assets/coder_pro/components/leds.webp) | ![Buzzer](../../assets/coder_pro/components/Buzzer.png) | ![Resistor](../../assets/coder_pro/components/resistors.webp) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
