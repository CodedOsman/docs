# Project 3.22: Dot Matrix Word Scroller
...
| ![Arduino Uno](../../assets/coder_pro/components/arduino.webp) | ![Bread Board](../../assets/coder_pro/components/breadboard.webp) | ![Arduino USB Cable](../../assets/coder_pro/components/usbcable.webp) | ![Jumper Wires](../../assets/coder_pro/components/jumperwires.webp) | ![8x8 Dot Matrix Module](../../assets/coder_pro/components/8x8dotmatrix.webp) |
| --- | --- | --- | --- | --- |
...
**Step 2:** Connect the MAX7219 Dot Matrix Module:

**Step 3:** Connect the DIN pin to Digital Pin 11 on the Arduino Uno for serial data input.

**Step 4:** Connect the CLK pin to Digital Pin 13 on the Arduino Uno for the clock signal.

**Step 5:** Connect the CS (Load) pin to Digital Pin 10 on the Arduino Uno for the chip select (latch) signal.

**Step 6:** Connect the VCC pin to the 5V power rail on the breadboard.

**Step 7:** Connect the GND pin to the ground rail on the breadboard.

**Step 8:** Ensure all GND connections share the same ground line on the breadboard. Check the polarity of the MAX7219 module and verify that all connections are secure before supplying power.

![Components on breadboard](../../assets/coder_pro/3.0/Dot_Matrix_Word_Scroller/circuit_1.png)
