...
This project introduces serial Bluetooth communication and demonstrates how a smartphone can be used as a wireless controller — the basis of Bluetooth home automation, wireless sensor readouts, and IoT devices.|
|------------------|----------------------------------------------------------------|
