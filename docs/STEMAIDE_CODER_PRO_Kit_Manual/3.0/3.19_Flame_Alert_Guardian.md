...
| **Description** | In this project, learners will build a flame detection system that activates a buzzer and an LED alert when fire or a strong infrared light source is detected. The flame sensor module detects infrared radiation emitted by flames in a detection range of approximately 60 cm.
This project introduces environmental safety sensing and threshold-based alerting, which are foundational concepts in fire alarm systems and industrial safety automation.|
|------------------|----------------------------------------------------------------|
