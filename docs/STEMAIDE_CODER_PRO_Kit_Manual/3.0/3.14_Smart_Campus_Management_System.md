...
|------------------|----------------------------------------------------------------|
| **Use case**     | This project is connected to real-world uses such as: demonstrates how educational institutions can combine attendance systems and environmental monitoring into a unified management platform. |
...
- Connect the MFRC522 RFID reader to the Arduino Uno using the SPI pins. Connect SDA (SS) to Digital Pin 10, SCK to Digital Pin 13, MOSI to Digital Pin 11, MISO to Digital Pin 12, and RST to Digital Pin 9. Connect the 3.3V pin of the RFID reader to the 3.3V pin on the Arduino Uno and the GND pin to GND using jumper wires.
...
- Check the polarity of the buzzer, LCD module, and sensor modules before connecting USB power.
