...
| **Description** | In this project, learners will create a Smart Energy Consumption Monitor that simulates monitoring electrical appliance usage. A potentiometer represents varying power consumption levels, while LEDs indicate low, medium, and high energy usage. An LCD displays the current energy level.
This project introduces monitoring systems used in smart homes and energy management applications.
|
|------------------|----------------------------------------------------------------|
...
| ![Arduino Uno](../../assets/coder_pro/components/arduino.webp) | ![Bread Board](../../assets/coder_pro/components/breadboard.webp) | ![Arduino USB Cable](../../assets/coder_pro/components/usbcable.webp) | ![Jumper Wires](../../assets/coder_pro/components/jumperwires.webp) | ![LED](../../assets/coder_pro/components/leds.webp) | ![LCD Display](../../assets/coder_pro/components/lcdscreen.jpg) | ![Resistor](../../assets/coder_pro/components/resistors.webp) | ![Potentiometer](../../assets/coder_pro/components/potentiometer.png) |
| ![Arduino Uno](../../assets/coder_pro/components/arduino.webp) | ![Bread Board](../../assets/coder_pro/components/breadboard.webp) | 
|---|---|---|---|---|---|---|---|
...
- Place the Potentiometer and I²C LCD Display on the breadboard.

- Connect the Potentiometer by connecting the left pin to GND, the middle (wiper) pin to Analog Pin A0, and the right pin to 5V on the Arduino Uno.
