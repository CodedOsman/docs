...
**Step 3:**	Place the I2C LCD display on the breadboard.
   ...
   - Connect VCC of the LCD display to the positive power rail of the breadboard where we connected the 5V pin on the Arduino Uno to.

   - Connect GND of the LCD display to the negative power rail of the breadboard where we connected the GND pin on the Arduino Uno to.
