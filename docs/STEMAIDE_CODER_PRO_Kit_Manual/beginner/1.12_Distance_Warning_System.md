...
![Components on breadboard](../../assets/coder_pro/beginner/Distance_Warning_System/circuit_1.png)

**Step 2:**	Connect VCC pin of the ultrasonic sensor to 5V on the Arduino using the jumper wire.

![Components on breadboard](../../assets/coder_pro/beginner/Distance_Warning_System/circuit_2.png)

**Step 3:**	Connect GND pin of the ultrasonic sensor to GND using a jumper wire.

![Components on breadboard](../../assets/coder_pro/beginner/Distance_Warning_System/circuit_3.png)

**Step 4:**	Connect Trig pin of the ultrasonic sensor to Pin 9 using a jumper wire.

![Components on breadboard](../../assets/coder_pro/beginner/Distance_Warning_System/circuit_4.png)

**Step 5:** Connect Echo pin of the ultrasonic sensor to Pin 10 using a jumper wire.

![Components on breadboard](../../assets/coder_pro/beginner/Distance_Warning_System/circuit_5.png)

**Step 6:**	Connect Positive pin of the buzzer to Pin 8 using a jumper wire. 

![Components on breadboard](../../assets/coder_pro/beginner/Distance_Warning_System/circuit_6.png)

**Step 7:**	Connect Negative pin of the buzzer to GND using a jumper wire. 

![Components on breadboard](../../assets/coder_pro/beginner/Distance_Warning_System/circuit_7.png)
