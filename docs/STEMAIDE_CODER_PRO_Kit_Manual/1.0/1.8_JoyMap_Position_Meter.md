# Project 1.8: JoyMap Position Meter

| **Description** Learners read joystick movement and display a changing position value. The project introduces human input devices and data mapping.
...
|------------------|----------------------------------------------------------------|
| **Use case**     | This project is connected to real-world uses such as: Understanding game-controller inputs.; Measuring directional movement.; Introducing manual control interfaces. |
...
![Components on breadboard](../../assets/coder_pro/1.0/JoyMap_Position_Meter/circuit_1.png)
