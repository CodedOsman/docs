...
**Step 2:** Connect the VCC pin of the DS1302 module to the 5V power rail on the breadboard.

**Step 3:** Connect the GND pin of the DS1302 module to the ground rail on the breadboard.

**Step 4:** Connect the CLK pin of the DS1302 module to Digital Pin 6 on the Arduino Uno.

**Step 5:** Connect the DAT pin of the DS1302 module to Digital Pin 7 on the Arduino Uno.

**Step 6:** Connect the RST pin of the DS1302 module to Digital Pin 8 on the Arduino Uno.

**Step 7:** Ensure that all GND connections share a common ground. Verify that all wiring connections are secure before connecting the USB cable.
