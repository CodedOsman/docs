# Project 3.24: Stepper Motor Position Controller
...
**Step 2:** Connect the ULN2003 driver board to the Arduino Uno:

**Step 3:** Connect IN1 to Digital Pin 8.

**Step 4:** Connect IN2 to Digital Pin 9.

**Step 5:** Connect IN3 to Digital Pin 10.

**Step 6:** Connect IN4 to Digital Pin 11.

**Step 7:** Connect VCC (+5V) to the Arduino 5V pin.

**Step 8:** Connect GND to the Arduino GND pin.

**Step 9:** Connect the 28BYJ-48 stepper motor cable directly to the motor connector on the ULN2003 driver board. Ensure the connector is fully inserted and correctly aligned.

**Step 10:** Verify that all GND connections share a common ground. Check all wiring connections, ensuring the control pins, power, and motor connector are securely connected before applying power.

![Components on breadboard](../../assets/coder_pro/3.0/Stepper_Motor_Position_Controller/circuit_1.png)

**Step 11:** After confirming that all connections are correct, connect the USB cable to the Arduino Uno board and the computer to power the circuit.
