# Project 3.31: Rocket Switch Circuit Breaker
...
**Step 2:** Connect one terminal of the rocket switch to the 5V power rail on the breadboard.

**Step 3:** Connect the other terminal of the rocket switch to Digital Pin 2.

**Step 4:** Connect a 10 kΩ resistor between Pin 2 and GND. This keeps Pin 2 LOW when the switch is open.

**Step 5:** Connect the LED anode (+) to Pin 13 through a 220 Ω resistor.

**Step 6:** Connect the LED cathode (−) to the ground rail on the breadboard.

**Step 7:** Connect the buzzer positive (+) to Pin 8.

**Step 8:** Connect the buzzer negative (−) to the ground rail on the breadboard.

**Step 9:** Check that all GND connections share a common ground. Verify all connections before connecting the Arduino to USB power.

![Components on breadboard](../../assets/coder_pro/3.0/Rocket_Switch_Circuit_Breaker/circuit_1.png)
