# Project 3.29: Colour Sensor Object Identifier
...
**Step 2:** Identify the TCS34725 Colour Sensor Module, Arduino Uno, and test objects before starting.

**Step 3:** Connect TCS34725 VIN to the appropriate Arduino power supply, 5V if supported by your breakout board.

**Step 4:** Connect TCS34725 GND to Arduino GND.

**Step 5:** Connect TCS34725 SDA to Arduino A4. This is the I²C data connection.

**Step 6:** Connect TCS34725 SCL to Arduino A5. This is the I²C clock connection.

**Step 7:** Check that the sensor's power and ground connections are correct.

**Step 8:** Connect the Arduino Uno to the computer only after all wiring has been checked.

**Step 9:** Check the module's voltage requirements before connecting USB power.

![Components on breadboard](../../assets/coder_pro/3.0/Colour_Sensor_Object_Identifier/circuit_1.png)
