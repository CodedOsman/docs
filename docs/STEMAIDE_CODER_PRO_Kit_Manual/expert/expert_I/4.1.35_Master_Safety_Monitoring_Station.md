...
| ![Arduino Uno](../../../assets/coder_pro/components/arduino.webp) | ![Arduino USB Cable](../../../assets/coder_pro/components/usbcable.webp) | ![Bread Board](../../../assets/coder_pro/components/breadboard.webp) | ![Jumper Wires](../../../assets/coder_pro/components/jumperwires.webp) | ![BME Sensor](../../../assets/coder_pro/components/bme.jpg) | ![LCD Display](../../../assets/coder_pro/components/lcdscreen.jpg) | ![Buzzer](../../../assets/coder_pro/components/Buzzer.png) | ![Relay Module](../../../assets/coder_pro/components/relay.png) | ![Flame Sensor](../../../assets/coder_pro/components/flamesensor.jpg) | ![Water Sensor](../../../assets/coder_pro/components/watersensor.jpg) | ![Temperature Sensor](../../../assets/coder_pro/components/temperaturesensor.webp) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
**Step 2:** Connect the BME280 and LCD SDA to A4, and SCL to A5 (I2C Shared Bus).

**Step 3:** Connect the Flame Sensor to A0 and the Water Test Module to A1.

**Step 4:** Wire the Buzzer to Digital Pin 9 and the Relay Module to Digital Pin 8.
