# Project 4.1.8: Smart Fire Safety  Alarm System
...
**Step 3:** Place the 5V Relay Module on the breadboard.
  - Connect the VCC pin to the 5V power rail on the breadboard
  - Connect the GND pin to the ground rail on the breadboard
  - Connect the IN pin to Digital Pin 7

**Step 4:** Place the 5V Active Buzzer on the breadboard.
  - Connect its positive (+) pin to Digital Pin 8
  - Connect its negative (-) pin to the ground rail on the breadboard

**Step 5:** Place the 5mm Red LED on the breadboard.
...
![Components on breadboard](../../../assets/coder_pro/4.0/Smart_Fire_Safety_Alarm_System/circuit_1.png)
